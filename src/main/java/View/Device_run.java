...
//
        ...
        //        顶栏
        JLabel jLabel_title = new JLabel("设备运行管理检索方式");
        ...
        JButton jButton4 = new JButton("添加运行设备");
        ...
        jButton4.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                Device_run_enter dre = new Device_run_enter();
                dre.Device_run_enter_next();
            }
        });
